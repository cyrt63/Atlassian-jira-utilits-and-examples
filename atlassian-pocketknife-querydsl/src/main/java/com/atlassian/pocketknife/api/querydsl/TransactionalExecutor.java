...
{
    /**
     * Executes the provided {@code function} within a new transaction.
     * <p/>
     * The transaction will be committed immediately after the function completes.
     * <p/>
     ...
     * @throws java.lang.RuntimeException on failure to commit or roll back the transaction
